...
class DiaporamaImageTableMap extends TableMap
{
     ...
     */
    const FILE = 'diaporama_image.FILE';

    /**
     * the column name for the VISIBLE field
     */
    const VISIBLE = 'diaporama_image.VISIBLE';
     ...
     */
    const CREATED_AT = 'diaporama_image.CREATED_AT';

    /**
     * the column name for the UPDATED_AT field
     */
    const UPDATED_AT = 'diaporama_image.UPDATED_AT';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'DiaporamaId', 'File', 'Visible', 'Position', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'diaporamaId', 'file', 'visible', 'position', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(DiaporamaImageTableMap::ID, DiaporamaImageTableMap::DIAPORAMA_ID, DiaporamaImageTableMap::FILE, DiaporamaImageTableMap::VISIBLE, DiaporamaImageTableMap::POSITION, DiaporamaImageTableMap::CREATED_AT, DiaporamaImageTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'DIAPORAMA_ID', 'FILE', 'VISIBLE', 'POSITION', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'diaporama_id', 'file', 'visible', 'position', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'DiaporamaId' => 1, 'File' => 2, 'Visible' => 3, 'Position' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'diaporamaId' => 1, 'file' => 2, 'visible' => 3, 'position' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
        self::TYPE_COLNAME       => array(DiaporamaImageTableMap::ID => 0, DiaporamaImageTableMap::DIAPORAMA_ID => 1, DiaporamaImageTableMap::FILE => 2, DiaporamaImageTableMap::VISIBLE => 3, DiaporamaImageTableMap::POSITION => 4, DiaporamaImageTableMap::CREATED_AT => 5, DiaporamaImageTableMap::UPDATED_AT => 6, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'DIAPORAMA_ID' => 1, 'FILE' => 2, 'VISIBLE' => 3, 'POSITION' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'diaporama_id' => 1, 'file' => 2, 'visible' => 3, 'position' => 4, 'created_at' => 5, 'updated_at' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('DiaporamaImageI18n', '\\Diaporamas\\Model\\DiaporamaImageI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'DiaporamaImageI18ns');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DiaporamaImageTableMap::FILE);
            $criteria->addSelectColumn(DiaporamaImageTableMap::VISIBLE);
            $criteria->addSelectColumn(DiaporamaImageTableMap::POSITION);
            $criteria->addSelectColumn(DiaporamaImageTableMap::CREATED_AT);
            $criteria->addSelectColumn(DiaporamaImageTableMap::UPDATED_AT);
        } else {
