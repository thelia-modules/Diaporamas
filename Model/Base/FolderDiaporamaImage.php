...
use Diaporamas\Model\Thelia\Model\FolderImage as ChildFolderImage;
use Diaporamas\Model\Thelia\Model\FolderImageQuery;
...
abstract class FolderDiaporamaImage extends ChildDiaporamaImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Diaporamas\\Model\\Map\\FolderDiaporamaImageTableMap';
    ...
    /**
     * The value for the folder_image_id field.
     * @var        int
     */
    protected $folder_image_id;
    ...
    /**
     * Initializes internal state of Diaporamas\Model\Base\FolderDiaporamaImage object.
     */
    ...
    /**
     * Compares this with another <code>FolderDiaporamaImage</code> instance.  If
     * <code>obj</code> is an instance of <code>FolderDiaporamaImage</code>, delegates to
     * <code>equals(FolderDiaporamaImage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return FolderDiaporamaImage The current object, for fluid interface
     */
    ...
    /**
     * Get the [folder_image_id] column value.
     *
     * @return   int
     */
    public function getFolderImageId()
    {

        return $this->folder_image_id;
    }
    ...
    /**
     * Set the value of [folder_image_id] column.
     *
     * @param      int $v new value
     * @return   \Diaporamas\Model\FolderDiaporamaImage The current object (for fluent API support)
     */
    public function setFolderImageId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->folder_image_id !== $v) {
            $this->folder_image_id = $v;
            $this->modifiedColumns[FolderDiaporamaImageTableMap::FOLDER_IMAGE_ID] = true;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[FolderDiaporamaImageTableMap::POSITION] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[FolderDiaporamaImageTableMap::ID] = true;
        }
    ...
    public function setDiaporamaId($v)
    {
        ...
        if ($this->diaporama_id !== $v) {
            $this->diaporama_id = $v;
            $this->modifiedColumns[FolderDiaporamaImageTableMap::DIAPORAMA_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FolderDiaporamaImageTableMap::translateFieldName('FolderImageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->folder_image_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FolderDiaporamaImageTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FolderDiaporamaImageTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FolderDiaporamaImageTableMap::translateFieldName('DiaporamaId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = FolderDiaporamaImageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Diaporamas\Model\FolderDiaporamaImage object", 0, $e);
        }
    }
    ...
    {
        if ($this->aFolderImage !== null && $this->folder_image_id !== $this->aFolderImage->getId()) {
            $this->aFolderImage = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFolderDiaporamaImageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FolderDiaporamaImage::setDeleted()
     * @see FolderDiaporamaImage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildFolderDiaporamaImageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FolderDiaporamaImageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::FOLDER_IMAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'FOLDER_IMAGE_ID';
        }
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::POSITION)) {
            $modifiedColumns[':p' . $index++]  = 'POSITION';
        }
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::DIAPORAMA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DIAPORAMA_ID';
        }

        $sql = sprintf(
            'INSERT INTO folder_diaporama_image (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'FOLDER_IMAGE_ID':
                        $stmt->bindValue($identifier, $this->folder_image_id, PDO::PARAM_INT);
                        break;
                    case 'POSITION':
    ...
    {
        $pos = FolderDiaporamaImageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FolderDiaporamaImage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FolderDiaporamaImage'][$this->getPrimaryKey()] = true;
        $keys = FolderDiaporamaImageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFolderImageId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFolderImageId($arr[$keys[0]]);
    ...
    {
        $criteria = new Criteria(FolderDiaporamaImageTableMap::DATABASE_NAME);

        if ($this->isColumnModified(FolderDiaporamaImageTableMap::FOLDER_IMAGE_ID)) $criteria->add(FolderDiaporamaImageTableMap::FOLDER_IMAGE_ID, $this->folder_image_id);
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::POSITION)) $criteria->add(FolderDiaporamaImageTableMap::POSITION, $this->position);
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::ID)) $criteria->add(FolderDiaporamaImageTableMap::ID, $this->id);
        if ($this->isColumnModified(FolderDiaporamaImageTableMap::DIAPORAMA_ID)) $criteria->add(FolderDiaporamaImageTableMap::DIAPORAMA_ID, $this->diaporama_id);
    ...
    {
        $criteria = new Criteria(FolderDiaporamaImageTableMap::DATABASE_NAME);
        $criteria->add(FolderDiaporamaImageTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Diaporamas\Model\FolderDiaporamaImage (or compatible) type.
    ...
    {
        $copyObj->setFolderImageId($this->getFolderImageId());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Diaporamas\Model\FolderDiaporamaImage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setFolderImageId(NULL);
        } else {
            $this->setFolderImageId($v->getId());
        }
        ...
        if ($v !== null) {
            $v->addFolderDiaporamaImage($this);
        }
    ...
    {
        if ($this->aFolderImage === null && ($this->folder_image_id !== null)) {
            $this->aFolderImage = FolderImageQuery::create()->findPk($this->folder_image_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFolderImage->addFolderDiaporamaImages($this);
             */
        }
    ...
    public function setDiaporamaImage(ChildDiaporamaImage $v = null)
    {
        ...
        if ($v !== null) {
            $v->setFolderDiaporamaImage($this);
        }
    ...
    public function getDiaporamaImage(ConnectionInterface $con = null)
    {
        if ($this->aDiaporamaImage === null && ($this->id !== null)) {
            ...
            $this->aDiaporamaImage->setFolderDiaporamaImage($this);
        }
    ...
    public function getDiaporama(ConnectionInterface $con = null)
    {
        if ($this->aDiaporama === null && ($this->diaporama_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDiaporama->addFolderDiaporamaImages($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FolderDiaporamaImageTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    public function getParentOrCreate($con = null)
    {
        if ($this->isNew()) {
            if ($this->isPrimaryKeyNull()) {
                ...
                $parent->setDescendantClass('Diaporamas\Model\FolderDiaporamaImage');
    ...
    public function validate(Validator $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            if (method_exists($this->aFolderImage, 'validate')) {
                if (!$this->aFolderImage->validate($validator)) {
                    $failureMap->addAll($this->aFolderImage->getValidationFailures());
                }
            }
            // If validate() method exists, the validate-behavior is configured for related object
