...
use Diaporamas\Model\Thelia\Model\BrandImageQuery;
use Diaporamas\Model\Thelia\Model\BrandImage as ChildBrandImage;
...
abstract class BrandDiaporamaImage extends ChildDiaporamaImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Diaporamas\\Model\\Map\\BrandDiaporamaImageTableMap';
    ...
    /**
     * The value for the brand_image_id field.
     * @var        int
     */
    protected $brand_image_id;
    ...
    /**
     * Initializes internal state of Diaporamas\Model\Base\BrandDiaporamaImage object.
     */
    ...
    /**
     * Compares this with another <code>BrandDiaporamaImage</code> instance.  If
     * <code>obj</code> is an instance of <code>BrandDiaporamaImage</code>, delegates to
     * <code>equals(BrandDiaporamaImage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return BrandDiaporamaImage The current object, for fluid interface
     */
    ...
    /**
     * Get the [brand_image_id] column value.
     *
     * @return   int
     */
    ...
    /**
     * Set the value of [brand_image_id] column.
     *
     * @param      int $v new value
     * @return   \Diaporamas\Model\BrandDiaporamaImage The current object (for fluent API support)
     */
    public function setBrandImageId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->brand_image_id !== $v) {
            $this->brand_image_id = $v;
            $this->modifiedColumns[BrandDiaporamaImageTableMap::BRAND_IMAGE_ID] = true;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[BrandDiaporamaImageTableMap::POSITION] = true;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BrandDiaporamaImageTableMap::ID] = true;
        }
    ...
    public function setDiaporamaId($v)
    {
        ...
        if ($this->diaporama_id !== $v) {
            $this->diaporama_id = $v;
            $this->modifiedColumns[BrandDiaporamaImageTableMap::DIAPORAMA_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BrandDiaporamaImageTableMap::translateFieldName('BrandImageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->brand_image_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BrandDiaporamaImageTableMap::translateFieldName('Position', TableMap::TYPE_PHPNAME, $indexType)];
            $this->position = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BrandDiaporamaImageTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BrandDiaporamaImageTableMap::translateFieldName('DiaporamaId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = BrandDiaporamaImageTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Diaporamas\Model\BrandDiaporamaImage object", 0, $e);
        }
    }
    ...
    {
        if ($this->aBrandImage !== null && $this->brand_image_id !== $this->aBrandImage->getId()) {
            $this->aBrandImage = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBrandDiaporamaImageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see BrandDiaporamaImage::setDeleted()
     * @see BrandDiaporamaImage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildBrandDiaporamaImageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BrandDiaporamaImageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::BRAND_IMAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'BRAND_IMAGE_ID';
        }
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::POSITION)) {
            $modifiedColumns[':p' . $index++]  = 'POSITION';
        }
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::DIAPORAMA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DIAPORAMA_ID';
        }

        $sql = sprintf(
            'INSERT INTO brand_diaporama_image (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'BRAND_IMAGE_ID':
                        $stmt->bindValue($identifier, $this->brand_image_id, PDO::PARAM_INT);
                        break;
                    case 'POSITION':
    ...
    {
        $pos = BrandDiaporamaImageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BrandDiaporamaImage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BrandDiaporamaImage'][$this->getPrimaryKey()] = true;
        $keys = BrandDiaporamaImageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBrandImageId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setBrandImageId($arr[$keys[0]]);
    ...
    {
        $criteria = new Criteria(BrandDiaporamaImageTableMap::DATABASE_NAME);

        if ($this->isColumnModified(BrandDiaporamaImageTableMap::BRAND_IMAGE_ID)) $criteria->add(BrandDiaporamaImageTableMap::BRAND_IMAGE_ID, $this->brand_image_id);
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::POSITION)) $criteria->add(BrandDiaporamaImageTableMap::POSITION, $this->position);
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::ID)) $criteria->add(BrandDiaporamaImageTableMap::ID, $this->id);
        if ($this->isColumnModified(BrandDiaporamaImageTableMap::DIAPORAMA_ID)) $criteria->add(BrandDiaporamaImageTableMap::DIAPORAMA_ID, $this->diaporama_id);
    ...
    {
        $criteria = new Criteria(BrandDiaporamaImageTableMap::DATABASE_NAME);
        $criteria->add(BrandDiaporamaImageTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Diaporamas\Model\BrandDiaporamaImage (or compatible) type.
    ...
    {
        $copyObj->setBrandImageId($this->getBrandImageId());
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Diaporamas\Model\BrandDiaporamaImage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($v === null) {
            $this->setBrandImageId(NULL);
        } else {
            $this->setBrandImageId($v->getId());
        }
    ...
    {
        if ($this->aBrandImage === null && ($this->brand_image_id !== null)) {
            $this->aBrandImage = BrandImageQuery::create()->findPk($this->brand_image_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBrandImage->addBrandDiaporamaImages($this);
             */
        }
    ...
    public function getDiaporamaImage(ConnectionInterface $con = null)
    {
        if ($this->aDiaporamaImage === null && ($this->id !== null)) {
            ...
            $this->aDiaporamaImage->setBrandDiaporamaImage($this);
        }
    ...
    public function getDiaporama(ConnectionInterface $con = null)
    {
        if ($this->aDiaporama === null && ($this->diaporama_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDiaporama->addBrandDiaporamaImages($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BrandDiaporamaImageTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    public function getParentOrCreate($con = null)
    {
        if ($this->isNew()) {
            if ($this->isPrimaryKeyNull()) {
                ...
                $parent->setDescendantClass('Diaporamas\Model\BrandDiaporamaImage');
    ...
    public function validate(Validator $validator = null)
    {
        ...
        if (!$this->alreadyInValidation) {
            ...
            if (method_exists($this->aBrandImage, 'validate')) {
                if (!$this->aBrandImage->validate($validator)) {
                    $failureMap->addAll($this->aBrandImage->getValidationFailures());
                }
            }
            // If validate() method exists, the validate-behavior is configured for related object
